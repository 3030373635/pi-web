...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "agents.empty": "Select or create an agent profile",
    "agents.readOnly": "This profile comes from a shared or built-in source.",
    "agents.overrideGlobal": "Override globally",
    "agents.overrideProject": "Override in project",
    ...
    "subagent.open": "Open subagent session",
