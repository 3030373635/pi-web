...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "system.toolsCount": "{count} active",
    "system.toolsLoad": "Tool definitions have not loaded yet",
    "system.toolsLoading": "Loading tool definitions…",
    "system.noTools": "No active tools",
    "system.parameters": "Parameters",
    "system.parameterCount": "{count} parameters",
    "system.noParameters": "No parameters",
    "system.required": "Required",
    "system.optional": "Optional",
    "system.allowedValues": "Allowed",
    "system.defaultValue": "Default",
    "system.guidelines": "Prompt guidelines",
