...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "system.label": "系统",
    "system.tools": "工具定义",
    "system.toolsCount": "已启用 {count} 个",
    "system.toolsLoad": "工具定义尚未加载",
    "system.toolsLoading": "正在加载工具定义…",
    "system.noTools": "没有启用的工具",
    "system.parameters": "参数",
    "system.parameterCount": "{count} 个参数",
    "system.noParameters": "无参数",
    "system.required": "必填",
    "system.optional": "可选",
    "system.allowedValues": "可选值",
    "system.defaultValue": "默认值",
    "system.guidelines": "提示词规则",
    "session.info": "会话信息",
    "session.name": "名称",
    "session.file": "文件",
