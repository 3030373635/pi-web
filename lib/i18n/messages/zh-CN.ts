...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "agents.new": "新建智能体",
    "agents.empty": "选择或创建一个智能体配置",
    "agents.readOnly": "该配置来自共享目录或内置配置。",
    "agents.overrideGlobal": "覆盖到全局",
    "agents.overrideProject": "覆盖到项目",
